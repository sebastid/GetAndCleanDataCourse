...
* download the zip package from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip.
* unzip the file to a chosen working directory, i.e.:'~/Documents/Coursera/Getdata/GetAndCleanDataCourse'.
* edit the setwd() command in the script to point to the correct working directory, i.e.: setwd("~/Documents/Coursera/Getdata/GetAndCleanDataCourse").
* execute the [run_analysis.R](./run_analysis.R) script from R or RStudio and review the saved tidy data set file 'tiny_data.txt'.
